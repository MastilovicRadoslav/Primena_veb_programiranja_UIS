...
namespace PredictionService
{
    ...
    /// </summary>
    public sealed class PredictionService : StatelessService, IPredictionService //Nema trajnu memmoriju zato je stateless
    {
        ...
        public async Task<PredictionModel> GetPredictionPrice(string currentLocation, string destination)
        {
            ...
            return new PredictionModel(price, estimatedTimeMin, estimatedTimeMax);//vraca cenu i nasumico vreme dolaska vozaca
